...
- [ ] 阅读 [[GPT Image 2]]，理解自回归架构与扩散模型的差异
- [ ] 阅读 [[concepts/autoregressive-image-generation.md|自回归图像生成]]
- [ ] 理解 GPT Image 2 的五大强项：文字渲染、复杂排版、指令遵循、对话迭代、原生图像编辑
- [ ] 理解"模糊愿望"与"可执行指令"的区别
- [ ] 完成"同一主题三种清晰度"练习（日落海边）
- [ ] 对比三条提示词的画面差异，记录观察
